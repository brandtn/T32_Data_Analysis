...
student_data %>%
  ...
  scale_x_discrete(labels = c("Asian/Pacific Islander", "Black", "Hispanic", "Two or More Races","White", "Declined to Answer", "International")) +
  theme_classic() +
  theme(axis.ticks = element_line(size=1), axis.title = element_blank(), axis.text = element_blank())


ggsave(paste("Ethnicity_Bar_Blank_",(current.year - filter.year),".jpg", sep = ""), dpi =600)
...
student_data %>%
  ...
  xlab("") +
  theme_bw() +
  theme(panel.border = element_rect(size=1), axis.ticks = element_line(size=1), axis.ticks.x = element_blank(), axis.title = element_blank(), axis.text = element_blank())

ggsave(paste("StudentYearstoPhD_Boxplot_",(current.year - filter.year),".jpg", sep = ""), dpi = 600)
...
ggsave(paste("Number_1stAuthorPapers_Blank",(current.year - filter.year),".jpg", sep = ""),dpi = 600)
...
ggsave(paste("PositionUponGrad_Bar_",(current.year - filter.year),".jpg", sep = ""),plot = temp,  dpi = 600)
...
ggsave(paste("PositionUponGrad_Blank_",(current.year - filter.year),".jpg", sep = ""), dpi =600)
